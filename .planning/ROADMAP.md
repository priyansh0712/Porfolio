...
**Goal:** Provide schools with complete academic management (Standards, Divisions, Subjects) and a 4-step Excel/CSV bulk import wizard to easily onboard Faculty, Class Teachers, Subject Teachers, and Students with automatic mapping and role-based permissions.

### Phase 10: Academic Hierarchy & Teacher Allocations
...
- **Success Criteria:**
  1. School Admin can create and switch Active Academic Years per tenant.
  2. School Admin can create Standards, Divisions, and Subjects with duplicate prevention.
  3. School Admin can assign Class Teachers and Subject Teachers with strict validation.

### Phase 11: Student Master Records, Scoped CRUD & Transfer Requests
**Goal:** Build Student models with unique GR numbers, soft-delete mechanisms, and role-based CRUD permissions (Principal full access, Class Teacher scoped access with locked GR numbers).
...
### Phase 12: 4-Step Bulk Excel/CSV Onboarding Engine
...
- **Success Criteria:**
  ...
  4. Step 4 imports students with duplicate GR No checks and shows an interactive validation preview before atomic commit.

### Phase 13: Faculty Portal Views, Password Security & Integration Polish
**Goal:** Provide faculty with dedicated "My Class" and "My Subjects" dashboards, self-service password changing, and end-to-end security test verification.
...
- **Success Criteria:**
  ...
  3. Faculty can update their password and profile details.
