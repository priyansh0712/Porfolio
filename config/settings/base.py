...
DEBUG = env('DEBUG')
ALLOWED_HOSTS = env.list('ALLOWED_HOSTS', default=['127.0.0.1', 'localhost', '.localhost', '.ourapp.com'])

# Password Hashing - Argon2id first for modern security
PASSWORD_HASHERS = [
...
MIDDLEWARE = [
    ...
    'apps.accounts.middleware.TenantRoleAccessMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.announcements.context_processors.pending_principal_notice',
